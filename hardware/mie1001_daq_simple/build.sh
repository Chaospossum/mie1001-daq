...
# rev D: leakage check around the preamp input (fails the build on any unexpected neighbour)
...
# JLCPCB assembly BOM + pick-and-place for the preamp SMD parts, and the gerber zip
python3 make_fab.py
