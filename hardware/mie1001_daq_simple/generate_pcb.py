...
def main():
    ...
    silk("MIE1001 TEAM 5", -26.2, 43.0, 1.4, just="left", bold=True)
    silk("DATA ACQUISITION", -25.5, 40.8, 1.0, just="left")
    silk("IMAGING ENGINEERING 2026", -25.5, 39.2, 1.0, just="left")
